...
describe("GamePlayBoardComponent", () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
        ...
        declarations: [
          GamePlayHistoryComponent, GamePlayBoardComponent],
  ...
  it("should match tiles", () => {
    fixture.whenStable().then(() => {

      const list = component.getHint();
      component.onSelected(list[0]);
      component.onSelected(list[1]);
      expect(component.seenMatches.length).toEqual(10);
  ...
  it("should show hints", () => {
    fixture.whenStable().then(() => {
      ...
      component.getGameData("5948ce053b7cc40011a52011").then(c => {
        expect(component.getHint()).toBeTruthy();
      });
    });
  });
